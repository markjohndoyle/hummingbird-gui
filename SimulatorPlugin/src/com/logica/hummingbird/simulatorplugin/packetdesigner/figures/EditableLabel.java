...
/**
 * A customized Label based on the label used in the flow example. Primary selection is denoted by highlight and focus
 * rectangle. Normal selection is denoted by highlight only. Borrowed from the Flow Editor example
 * 
 * @author Daniel Lee
 */
