package org.hbird.rcpgui.ssprequester.preferences;
...
import org.hbird.rcpgui.ssprequester.Activator;
...
public class SpaceSystemPublisherPreferences extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	public SpaceSystemPublisherPreferences() {
		super(GRID);
