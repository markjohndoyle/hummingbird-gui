...
/**
 * This is the item provider adapter for a {@link org.omg.space.xtce.ContainerType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XtcePackage.eINSTANCE.getContainerType_DefaultRateInStream());
			childrenFeatures.add(XtcePackage.eINSTANCE.getContainerType_RateInStreamSet());
			childrenFeatures.add(XtcePackage.eINSTANCE.getContainerType_BinaryEncoding());
		}
	...
	public String getText(Object object) {
		String label = ((ContainerType)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XtcePackage.eINSTANCE.getContainerType_DefaultRateInStream(),
				 XtceFactory.eINSTANCE.createRateInStreamType1()));

		newChildDescriptors.add
			(createChildParameter
				(XtcePackage.eINSTANCE.getContainerType_RateInStreamSet(),
				 XtceFactory.eINSTANCE.createRateInStreamSetType()));

		newChildDescriptors.add
			(createChildParameter
				(XtcePackage.eINSTANCE.getContainerType_BinaryEncoding(),
