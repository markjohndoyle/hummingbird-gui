...
/**
 * This is the item provider adapter for a {@link org.omg.space.xtce.ServiceRefType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceRefTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceRefType_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceRefType_value_feature", "_UI_ServiceRefType_type"),
				 XtcePackage.eINSTANCE.getServiceRefType_Value(),
				 true,
				 false,
				 false,
	...
	protected void addServiceRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ServiceRefType_serviceRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ServiceRefType_serviceRef_feature", "_UI_ServiceRefType_type"),
				 XtcePackage.eINSTANCE.getServiceRefType_ServiceRef(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ServiceRefType)object).getValue();
