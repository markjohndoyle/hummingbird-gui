...
/**
 * This is the item provider adapter for a {@link org.omg.space.xtce.ServiceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XtcePackage.eINSTANCE.getServiceType_MessageRefSet());
			childrenFeatures.add(XtcePackage.eINSTANCE.getServiceType_ContainerRefSet());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XtcePackage.eINSTANCE.getServiceType_MessageRefSet(),
				 XtceFactory.eINSTANCE.createMessageRefSetType()));

		newChildDescriptors.add
			(createChildParameter
				(XtcePackage.eINSTANCE.getServiceType_ContainerRefSet(),
				 XtceFactory.eINSTANCE.createContainerRefSetType()));
	}
