 ...
 * <ul>
 *   <li>{@link org.omg.space.xtce.impl.MessageSetTypeImpl#getMessage <em>Message</em>}</li>
 *   <li>{@link org.omg.space.xtce.impl.MessageSetTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageSetTypeImpl extends EObjectImpl implements MessageSetType {
	...
	protected EClass eStaticClass() {
		return XtcePackage.eINSTANCE.getMessageSetType();
	}
	...
	public EList<MessageType> getMessage() {
		if (message == null) {
			message = new EObjectContainmentEList<MessageType>(MessageType.class, this, XtcePackage.MESSAGE_SET_TYPE__MESSAGE);
		}
		return message;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XtcePackage.MESSAGE_SET_TYPE__NAME, oldName, name));
	}
